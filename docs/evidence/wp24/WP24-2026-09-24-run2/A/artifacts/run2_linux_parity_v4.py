...
def register():
    ...
    family = {
        ...
        "model_description": "WP24 shared_revision, linux parity run (vllm engine, gpu_memory_utilization 0.70 to match B)",
...
def launch_and_wait(tag):
    ...
    def do_launch():
        ...
        st, body = api("POST", "/v1/models", {
            ...
            "quantization": "none", "n_gpu": 1, "max_model_len": 8192, "gpu_memory_utilization": 0.70,
