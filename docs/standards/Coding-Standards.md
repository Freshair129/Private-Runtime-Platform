...
เอกสารที่เกี่ยวข้อง: [SRS](../SRS-PRP.md) · [Architecture](../ARCH-PRP.md) · [Stack Evaluation](../STACK-EVALUATION-PRP.md)
...
ห้ามใช้ผล `tools/docs/validate_docs.py` แทนคำสั่งข้างต้น เพราะตรวจโครงสร้างเอกสารเท่านั้น Schema/build/import/dependency checks เป็นส่วนหนึ่งของ CI ไม่ใช่ substitute for integration/physical tests
