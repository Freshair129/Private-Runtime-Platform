...
A strict 3-gate verification process is enforced for every task to ensure stability and maintainability.
...
- [ ] **Docs Updated**: Relevant files updated (`README.md`, `AGENTS.md`, `JSDoc`, `llms`).
