#!/usr/bin/env python3
"""Validate this documentation package, not a running PRP implementation.
...
srs=(ROOT/'docs/SRS-PRP.md').read_text(encoding='utf-8')
tests=(ROOT/'docs/TEST-PRP.md').read_text(encoding='utf-8')
...
spec=read_json('contracts/openapi-prp-v0.3.0.json')
refs=[]
def scan(o):
...
trace=(ROOT/'docs/TRACEABILITY-PRP.md').read_text(encoding='utf-8')
for r in requirements:
...
roadtext=(ROOT/'docs/ROADMAP-PRP.md').read_text(encoding='utf-8')
for w in roadmap:
